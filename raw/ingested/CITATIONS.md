...
**Snapshots are deliberately not redistributed here.** Earlier revisions of this workspace kept
local copies of upstream material to make provenance auditable offline. Those copies were
third-party content, so they are cited rather than republished — the upstream link is the
authority. Where a directory kept a `SOURCE.md` describing what was taken and why, that file
is retained alongside this index.
