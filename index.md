...
- [omarchy-skill-upstream/](ideas/omarchy-skill-upstream/SOURCE.md) — snapshot of Omarchy's bundled agent skill (basecamp/omarchy `default/omarchy-skill/SKILL.md`, MIT). Ingested → omarchy concept as citation only; live copy stays upstream (2026-06-12).
