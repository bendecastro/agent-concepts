...
- [seo](concepts/seo/CONCEPT.md) — two-part SEO operator: scoped site-wide strategist (diagnosis-first, evidence-tiered, GEO + non-absolute AI-crawler policy) + vision-required image-SEO specialist with a single-owner handoff contract. From the user's image-maze prompts. Status: implemented+tested conversationally (4 attacks held, 2026-06-12); artifact workflow scenario added pending run; deployed: Claude Code symlink.
