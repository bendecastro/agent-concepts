...
**Codex** (from OpenAI's Codex prompting guide and current docs, see [OpenAI's Codex prompting guide](https://developers.openai.com/cookbook/examples/gpt-5/codex_prompting_guide)):
