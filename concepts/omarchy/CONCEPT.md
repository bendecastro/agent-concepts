...
- `raw/omarchy-skill-upstream/` — immutable snapshot of the upstream SKILL.md with full citation (repo, path, commits, MIT license). Reference only; never deploy from it.
