...
`tests/accuracy-check.md` checks frontmatter, lean/progressive structure, JSON Canvas 1.0 invariants, ID/endpoint/layout guidance, mutation-authority rails, provenance, and deploy state. **PASS — 2026-08-17** after focused static checks and nine-link deployment verification.
