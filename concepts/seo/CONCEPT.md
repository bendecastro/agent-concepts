...
- `ideas/seo-primary-sources/` — the traced primary-documentation evidence base (Google Search Central, web.dev, W3C WAI, OpenAI bot docs); the claim→source map is [CITATIONS.md](./CITATIONS.md), which also lists the three not-yet-snapshotted gaps.
