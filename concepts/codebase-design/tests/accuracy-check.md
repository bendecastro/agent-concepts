...
Reference vocabulary — no runtime gate, so an accuracy check suffices (per AGENTS.md). Verify `body/SKILL.md` against the verbatim capture in `raw/pocock-skills-upstream/captured-skills.md`:
